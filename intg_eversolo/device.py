...
class EversoloDevice(PollingDevice):
    ...
    def _notify_entities(self) -> None:
        ...
        media_player_attrs = {
            ...
            MediaAttributes.SOUND_MODE: self.get_current_output() or "",
            MediaAttributes.SOUND_MODE_LIST: list(self.outputs.values()) if self.outputs else [],
        ...
        input_select_attrs = {
            ...
            SelectAttributes.CURRENT_OPTION: current_input if current_input else "",
