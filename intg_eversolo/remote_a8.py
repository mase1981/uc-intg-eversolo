"""
Eversolo Remote entity for DMP-A8 (Hybrid - Has Knob but No HDMI).
...
class EversoloRemoteA8(Remote):
    """Remote entity for Eversolo DMP-A8 with knob brightness but no HDMI."""
    ...
    async def handle_command(
        ...
        try:
            ...
            # Brightness commands (A8 has both display and knob)
